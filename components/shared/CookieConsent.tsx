...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[100] border-t border-white/10 bg-[#141414]/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-4 px-6 py-4 sm:flex-row sm:justify-between md:px-12">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="rounded-lg border border-white/10 px-4 py-2 text-sm font-medium text-[#888888] transition-colors hover:border-white/20 hover:text-[#f5f5f2]"
          >
