export const copy = {
  ...
  calculator: {
    meta: {
      title: 'Calculadora de Comisiones OTAs | OTAout',
      description: 'Calcula cuánto pagas en comisiones a Booking y Airbnb. Descubre cuánto puedes ahorrar con reservas directas.',
    },
    eyebrow: 'Calculadora gratuita',
    headline: '¿Cuánto te cuestan las OTAs?',
    subtitle: 'Introduce tus datos y descubre cuánto podrías ahorrar cambiando parte de tus reservas a tu propio canal directo.',
    form: {
      properties: 'Número de propiedades',
      avgNight: 'Precio medio por noche (€)',
      occupancy: 'Ocupación media anual (%)',
      avgStay: 'Estancia media (noches)',
    ...
    results: {
      ...
      annual_revenue: 'Facturación anual estimada',
      current: 'Lo que pagas hoy a las OTAs',
      ...
      otaoutSetup: 'Setup primer año',
      otaoutMonthly: 'Mantenimiento mensual',
      otaoutCommission: 'Comisión sobre reservas web (2%)',
      newTotal: 'Coste total nuevo modelo',
      savings: 'Ahorro anual neto',
      savingsPercent: 'Ahorro sobre comisiones actuales',
    ...
    cta: {
      ...
      button: 'Solicitar análisis gratuito',
      whatsapp: 'O escríbenos por WhatsApp',
    },
